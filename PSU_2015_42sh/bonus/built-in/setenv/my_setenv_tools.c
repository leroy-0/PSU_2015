...
** Last update Sun Jun  5 23:46:23 2016 longle_h
*/
...
char		*my_copy_searchenv(char **env, char *str, int cpt, int i)
{
  int		cpt_str;
...
char		*my_search_env(char *str, char **env)
{
  ...
  while (env && env[i] != NULL)
    {
      if (my_strcmp(str, env[i]) == 0 && env[i][my_strlen(str)] == '=')
	{
