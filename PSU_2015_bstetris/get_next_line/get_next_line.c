/*
** get_next_line.c for get_next_line in /home/leroy_0/rendu/CPE_2015_getnextline
**
** Made by leroy_0
** Login   <leroy_0@epitech.net>
**
** Started on  Wed Jan 13 21:19:07 2016 leroy_0
** Last update Sat Feb 20 17:56:44 2016 Tekm
*/
...
{
  while (buffer && buffer[where] != '\n' && buffer[where] != '\0')
    where++;
  if (buffer && buffer[where] == '\n')
    return (where);
  else
    return (-1);
  return (0);
